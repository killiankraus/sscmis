...
$(document).ready(function () {
    ...
    //                        swal("Error!", "Failed to login please try to communicate with your Administrator! ", "error");
    //                    }
    //                    else {
    //                        $("#password").val("");
    ...
    //                }
    //                else {
    //                    swal("Error!", "Your account is Inactive communicate with your Administrator! ", "error");
    //                }
    //            },
    //            error: function (res) {
